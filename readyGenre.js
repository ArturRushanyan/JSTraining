class MusicGenre {
    ...
    toString() {
        return this.getHistory() + 'Popular artists: ' + this.getArtistsList() + '\n';
    }
...
class Instrumental extends MusicGenre {
    ...
    toString() {
        return this.Instruments + super.toString();  // just return this.Instrument and log it outside of class
    }
};
...
class FolkInstrumental extends Instrumental {
    ...
    toString() {
        return super.toString() + this.origin + '\n';
    }
};
...
(function() {
    ...
    console.log('hasInfo: ' + obj.hasInfo('Linkin'));
